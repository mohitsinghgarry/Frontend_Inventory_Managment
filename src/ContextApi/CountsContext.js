  ...
  useEffect(() => {
    const fetchCounts = async () => {
      try {
        ...
        const productsRes = await fetch('https://backend-inventory-management-1-fxba.onrender.com/products/count');
        const ordersRes = await fetch('https://backend-inventory-management-1-fxba.onrender.com/orders/count');
        const customersRes = await fetch('https://backend-inventory-management-1-fxba.onrender.com/users/count');
        const lowStockRes = await fetch('https://backend-inventory-management-1-fxba.onrender.com/products/low-stock'); // Endpoint for low stock
        const recentOrdersRes = await fetch('https://backend-inventory-management-1-fxba.onrender.com/orders/recent-count'); // Endpoint for recent orders
